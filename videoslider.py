...
from PyQt5.QtGui import (QColor, QCursor, QKeyEvent, QMouseEvent, QPaintEvent, QPen,
                          QPixmap, QWheelEvent)
from PyQt5.QtWidgets import (QSlider, QStyle, QStyleOptionSlider, QStylePainter, QWidget,
                          qApp)
...
class VideoSlider(QSlider):
    def __init__(self, *arg, **kwargs):
        ...
        self.slider_cursor = QCursor(QPixmap(':/images/slider-cursor.png', 'PNG')) if sys.platform.startswith('linux') else Qt.SplitHCursor
        self.setFocus()
        self.initStyle()
