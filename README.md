...
The latest version of VidCutter can be installed as a snap package via the Snapcraft store at https://snapcraft.io/vidcutter or install it via the terminal as follows:
