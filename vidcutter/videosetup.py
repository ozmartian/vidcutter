...
class VCSetup:
    ...
    @staticmethod
    def display_install_notes() -> None:
        os.system('cls') if sys.platform == 'win32' else os.system('clear')
        pydoc.pager('''
*****************************************************************************

    VidCutter depends on the following packages from your Linux
    ...
    - PyQt5 w/ OpenGL module
        ...
        * Arch Linux:               python-pyqt5
        ...
        FYI, the additional OpenGL module is only required in
        Ubuntu/Debian as they split PyQt5 up into individual
        modules. It is already included in other distro packages.
